...
/**
 * @extends ServiceEntityRepository<Chartdata>
 *
...
class ChartdataRepository extends ServiceEntityRepository
{
    ...
    public function add(Chartdata $entity, bool $flush = false): void
    {
    ...
    public function remove(Chartdata $entity, bool $flush = false): void
    {
